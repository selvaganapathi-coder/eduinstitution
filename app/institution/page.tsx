        ...
        <Card bordered={false} className="!rounded-2xl !border !border-[#dadce0] !shadow-[0_1px_2px_rgba(60,64,67,.06)]">
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex min-w-0 items-start gap-4">
              ...
              <div className="min-w-0"><p className="mb-1 text-xs font-medium text-[#5f6368]">Current institution</p><h2 className="m-0 truncate text-xl font-medium text-[#202124]">{context.tenant.name}</h2><div className="mt-2 flex flex-wrap items-center gap-2"><Tag className="!rounded-full !border-[#dadce0] !bg-[#f8f9fa] !text-[#5f6368]">Active</Tag><span className="text-xs text-[#5f6368]">Institution details are available to authorized staff.</span></div></div>
            </div>
